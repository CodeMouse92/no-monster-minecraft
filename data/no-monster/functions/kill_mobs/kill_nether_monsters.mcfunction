...
execute as @e[type=blaze] run data modify entity @s Silent set value true
#teleport @e[type=blaze] ~ -1000 ~
kill @e[type=blaze]

execute as @e[type=ghast] run data modify entity @s DeathLootTable set value empty
execute as @e[type=ghast] run data modify entity @s Silent set value true
#teleport @e[type=ghast] ~ -1000 ~
kill @e[type=ghast]

execute as @e[type=magma_cube] run data modify entity @s DeathLootTable set value empty
execute as @e[type=magma_cube] run data modify entity @s Silent set value true
...
execute as @e[type=wither_skeleton] run data modify entity @s Silent set value true
...
execute as @e[type=zoglin] run data modify entity @s Silent set value true
